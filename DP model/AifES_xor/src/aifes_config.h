...
#define AIDEBUG_ENABLE_PRINTING
...
#define AIDEBUG_ENABLE_PRINTING /**< Enable printing to the console (switch off to save memory) */
    ...
    //MOJ#define AISTRING_STORAGE_WRAPPER(S)     const char S[]  /**< Specifies the storage type of strings like logs or names */
    #define AISTRING_STORAGE_WRAPPER(S, STR) const char S[] = STR
    ...
    //MOJ#define AILOG_E(MESSAGE)                ailog_e(MESSAGE)  /**< Logging function for errors */
    ...
    //MOJ#define AISTRING_STORAGE_WRAPPER(S)       /**< Specifies the storage type of strings like logs or names */
    #define AISTRING_STORAGE_WRAPPER(S, STR) const char S[] = STR
